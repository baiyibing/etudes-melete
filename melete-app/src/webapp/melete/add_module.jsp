...
<!--
 ***********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/webapp/melete/add_module.jsp $
 * $Id: add_module.jsp 12127 2015-11-25 15:10:28Z mallikamt $  
 ***********************************************************************************
 *
		     ...
		     <tr>
              ...
              <tr>
                ...
                <td  class="col2" valign="top">
                 <h:selectBooleanCheckbox id="hideuntilstart" title="hideUntilStart" value="#{addModulePage.moduleShdates.hideUntilStart}">
		         </h:selectBooleanCheckbox>
		         <h:outputText id="hideUntilStartTxt" value="#{msgs.add_module_hideuntilstart}" />
			   </td>
		     </tr>
