...
<!--
 ***********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/webapp/melete/view_module.jsp $
 * $Id: view_module.jsp 10642 2015-04-28 19:54:48Z mallikamt $  
 ***********************************************************************************
 *
 * Copyright (c) 2008, 2009, 2010, 2011, 2012, 2013, 2015 Etudes, Inc.
 *
...
<table width="100%" class="maintableCollapseWithBorder">
  <tr>
   <td align="right">
   <h:commandLink id="editMod" actionListener="#{viewModulesPage.editModule}" styleClass="toolUiLink" rendered="#{viewModulesPage.userStudent == false}">     
         <f:param name="editmodid" value="#{viewModulesPage.viewMbean.moduleId}" />
         <h:graphicImage id="editgif" alt="" value="/images/document_edit.gif" styleClass="AuthImgClass" />
         <h:outputText id="title2" value="#{msgs.edit_text}" />
      </h:commandLink>&nbsp;
 ...
 <f:param name="fromModuleSeqNo" value="#{viewModulesPage.moduleSeqNo}" />
  ...
  <h:outputLink id="printModuleLink" value="view_module" onclick="OpenPrintWindow(#{viewModulesPage.moduleId},'Melete Print Window');" rendered="#{viewModulesPage.printable}" styleClass="toolUiLink">
  ...
  <h:graphicImage id="printImgLink" value="/images/printer.png"  alt="#{msgs.list_auth_modules_alt_print}" title="#{msgs.list_auth_modules_alt_print}" styleClass="AuthImgClass"/>
   <h:outputText id="print" value="#{msgs.view_module_print}" />	
  </h:outputLink>
  </td>
  </tr>
</table>			  
