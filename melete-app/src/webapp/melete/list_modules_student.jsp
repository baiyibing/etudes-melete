...
<!--
 ***********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/webapp/melete/list_modules_student.jsp $
 * $Id: list_modules_student.jsp 11286 2015-07-16 21:42:32Z mallikamt $  
 ***********************************************************************************
 *
 ...
 <h:dataTable id="table" 
    ...
    <h:commandLink id="showHideSections" action="#{listModulesPage.showHideSections}" styleClass="toolUiLink">
      ...
      <h:outputText id="mod_seq" value="#{vmbean.seqNo}. " rendered="#{listModulesPage.autonumber}"/>
         <h:commandLink id="viewModule"  actionListener="#{listModulesPage.viewModule}" rendered="#{vmbean.visibleFlag == listModulesPage.trueFlag || listModulesPage.userObserver}" immediate="true" styleClass="toolUiLink">
              <f:param name="viewmodid" value="#{vmbean.moduleId}" />
               <h:outputText id="title"
                           value="#{vmbean.title}" rendered="#{vmbean.visibleFlag == listModulesPage.trueFlag}">
              </h:outputText>   
               <h:outputText id="title2"
                           value="#{vmbean.title}" styleClass="italics" rendered="#{listModulesPage.userObserver}">
              </h:outputText>            
          </h:commandLink>
          <h:outputText id="titleTxt2" value="#{vmbean.title}" rendered="#{vmbean.visibleFlag != listModulesPage.trueFlag && !listModulesPage.userObserver}"/>         
  ...
          <h:column> 
              ...
              <h:commandLink id="viewSectionEditor"   actionListener="#{listModulesPage.viewSection}"  rendered="#{((vsbean.contentType != listModulesPage.isNull && vsbean.contentType == listModulesPage.typeLink)&&(vmbean.visibleFlag == listModulesPage.trueFlag || listModulesPage.userObserver))}" styleClass="toolUiLink" immediate="true">
                <f:param name="viewmodid" value="#{vmbean.moduleId}" />  
                <f:param name="viewsecid" value="#{vsbean.sectionId}" /> 
                        
               <h:outputText id="sectitleEditor" 
                           value="#{vsbean.title}" rendered="#{vmbean.visibleFlag == listModulesPage.trueFlag}">
               </h:outputText>
               <h:outputText id="sectitleEditor2" 
                           value="#{vsbean.title}" styleClass="italics" rendered="#{listModulesPage.userObserver}">
               </h:outputText>
             </h:commandLink>
             <h:commandLink id="viewSectionLink"   actionListener="#{listModulesPage.viewSection}"   rendered="#{((vsbean.contentType != listModulesPage.isNull && vsbean.contentType != listModulesPage.typeLink)&&(vmbean.visibleFlag == listModulesPage.trueFlag || listModulesPage.userObserver))}" styleClass="toolUiLink" immediate="true">
               <f:param name="viewmodid" value="#{vmbean.moduleId}" />  
                <f:param name="viewsecid" value="#{vsbean.sectionId}" /> 
             ...
             <h:outputText id="sectitleEditorTxt2" value="#{vsbean.title}" rendered="#{vmbean.visibleFlag != listModulesPage.trueFlag &&  !listModulesPage.userObserver}"/>
    		</h:column>
          </h:dataTable>
          ...
          <h:commandLink id="whatsNext" actionListener="#{listModulesPage.goWhatsNext}" immediate="true" rendered="#{(vmbean.visibleFlag == listModulesPage.trueFlag || listModulesPage.userObserver)&&(vmbean.whatsNext != listModulesPage.isNull)&&((listModulesPage.expandAllFlag == listModulesPage.trueFlag)||(vmbean.moduleId == listModulesPage.showModuleId))}" styleClass="toolUiLink">
		    <h:outputText  id="whatsNextMsg" value="#{msgs.list_modules_stud_next_steps}" />
		    <f:param name="viewmodid" value="#{vmbean.moduleId}" />  
            <f:param name="viewmodseqno" value="#{vmbean.seqNo}" />
          </h:commandLink>  
          <h:outputText  id="whatsNextMsg2" value="#{msgs.list_modules_stud_next_steps}" rendered="#{(vmbean.visibleFlag != listModulesPage.trueFlag && !listModulesPage.userObserver)&&(vmbean.whatsNext != listModulesPage.isNull)&&((listModulesPage.expandAllFlag == listModulesPage.trueFlag)||(vmbean.moduleId == listModulesPage.showModuleId))}"/>
           </h:column>
           <h:column>   
             <f:facet name="header">
