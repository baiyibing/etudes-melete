...
<%--
 ***********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/webapp/melete/list_auth_modules.jsp $
 * $Id: list_auth_modules.jsp 12127 2015-11-25 15:10:28Z mallikamt $  
 ***********************************************************************************
 *
...
%>
 ...
 <tr>
   ...
   <h:dataTable id="table"
                  ...
                  var="mdbean"  headerClass="tableheader" rowClasses="row1,row2" columnClasses="ListModCheckClass,ListModCheckClass,ListTitleClass,ListClosedClass,ListAuthorDateClass,ListAuthorDateClass,ListAuthorDateClass,ListActionClass" 
...
        </h:column>      
       <h:column>   
         <f:facet name="header">
	          ...
	          <h:graphicImage id="close_gif" value="/images/view_closed.gif" alt="#{msgs.list_auth_modules_closed}" title="#{msgs.list_auth_modules_closed}" rendered="#{mdbean.moduleShdate.closedBeforeFlag == listAuthModulesPage.trueFlag}" styleClass="ExpClass"/>
              <h:graphicImage id="hide_gif" value="/images/invisible.png" alt="#{msgs.list_auth_modules_hideuntilopen}" title="#{msgs.list_auth_modules_hideuntilopen}" rendered="#{mdbean.moduleShdate.hiddenTillStart == listAuthModulesPage.trueFlag}" styleClass="ExpClass"/>
