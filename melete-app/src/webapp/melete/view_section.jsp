...
<!--
 ***********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/webapp/melete/view_section.jsp $
 * $Id: view_section.jsp 10535 2015-04-21 20:04:59Z mallikamt $  
 ***********************************************************************************
 *
...
<table width="100%" class="maintableCollapseWithBorder">
  <tr>
   <td align="right">
   <h:commandLink id="editSec" actionListener="#{viewSectionsPage.editSection}" styleClass="toolUiLink" rendered="#{viewSectionsPage.userStudent == false}">
      <f:param name="editsecmodid" value="#{viewSectionsPage.moduleId}" />  
      <f:param name="sectionId" value="#{viewSectionsPage.sectionId}" /> 
      <h:graphicImage id="editgif" alt="" value="/images/document_edit.gif" styleClass="AuthImgClass" />
     <h:outputText id="edittext" value="#{msgs.edit_text}">
     </h:outputText>
   </h:commandLink>&nbsp;										
