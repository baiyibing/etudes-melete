...
<!--
 ***********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/webapp/melete/edit_module.jsp $
 * $Id: edit_module.jsp 12127 2015-11-25 15:10:28Z mallikamt $  
 ***********************************************************************************
 *
...
<t:saveState id="empprevsec" value="#{editModulePage.prevSection}" />
<t:saveState id="empprevmod" value="#{editModulePage.prevMdBean}" />
<t:saveState id="empnextmod" value="#{editModulePage.nextMdBean}" />
          ...
          <td valign="top">
		  	<table class="maintableCollapseWithNoBorder">
		 		...
		 		<table  width="100%"> 
			                   <tr >
					            <td width="70%" style="padding:4px">  
					            	<h:commandButton id="editPrevItemButton" actionListener="#{editModulePage.editPrevItemListener}"  rendered="#{editModulePage.hasPrevItem}" value="#{msgs.editmodulesections_edit_prev}" accesskey="#{msgs.prev_access}" title="#{msgs.im_edit_prev}" styleClass="BottomImgPrev">
					 					    
					       			</h:commandButton>  
					       			    	   
									<h:commandButton id="TOCButton" action="#{editModulePage.gotoTOC}" value="#{msgs.edit_module_TOC}" accesskey="#{msgs.toc_access}" title="#{msgs.im_toc_text}" styleClass="BottomImgTOC"/>
					       			<h:commandButton id="editNextItemButton" actionListener="#{editModulePage.editNextItemListener}" rendered="#{editModulePage.hasNextItem}" value="#{msgs.editmodulesections_edit_next}" accesskey="#{msgs.next_access}" title="#{msgs.im_edit_next}" styleClass="BottomImgNext">
					    					       	
					       			</h:commandButton>
						     	   
						            <h:outputText id="text4_3" value="  " styleClass="ExtraPaddingClass"/>	
									<h:commandButton id="editAddNewButton" actionListener="#{editModulePage.addContentSections}" value="#{msgs.edit_module_add_content_sections}" accesskey="#{msgs.add_access}" title="#{msgs.im_save_text}" styleClass="BottomImgAdd">
	  		  ...
	  		  <tr>
			          	<td colspan="2" class="maintabledata9" style="padding:4px" >
			          	    <h:outputText id="mod_seq" value="#{editModulePage.moduleDateBean.cmod.seqNo}. " rendered="#{editModulePage.autonumber}"/>      
			     			<h:outputText id="text4" value="#{editModulePage.module.title}" />
			          	</td>
			          </tr>	 
              <tr>
			  ...
			  <tr>
                ...
                <td  class="col2" valign="top">
                 <h:selectBooleanCheckbox id="hideuntilstart" title="hideUntilStart" value="#{editModulePage.moduleShdates.hideUntilStart}">
		         </h:selectBooleanCheckbox>
		         <h:outputText id="hideUntilStartTxt" value="#{msgs.edit_module_hideuntilstart}" />
			   </td>
		     </tr>
			  <tr>
