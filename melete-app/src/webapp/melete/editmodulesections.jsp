...
<%--
 ***********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/webapp/melete/editmodulesections.jsp $
 * $Id: editmodulesections.jsp 12127 2015-11-25 15:10:28Z mallikamt $  
 ***********************************************************************************
 *
 * Copyright (c) 2008,2009,2010,2011,2012, 2014, 2015 Etudes, Inc.
 *
 * Portions completed before September 1, 2008 Copyright (c) 2004, 2005, 2006, 2007, 2008, 2015 Foothill College, ETUDES Project
 *
                   ...
                   <tr>
				            ...
				            <table  width="100%"> 
			                   <tr >
					            <td width="70%" style="padding:4px">  
					            	<h:commandButton id="editPrevButton" actionListener="#{editSectionPage.editPrevSectionListener}" rendered="#{editSectionPage.hasPrev}" value="#{msgs.editmodulesections_edit_prev}" accesskey="#{msgs.prev_access}" title="#{msgs.im_prev_text}" styleClass="BottomImgPrev">
					 					    
					       			</h:commandButton>  
					       			<h:commandButton id="editPrevModButton" actionListener="#{editSectionPage.editModuleListener}" rendered="#{!editSectionPage.hasPrev}" value="#{msgs.editmodulesections_edit_prev}" accesskey="#{msgs.prev_access}" title="#{msgs.im_prev_mod}" styleClass="BottomImgPrev">
									...
									<h:commandButton id="TOCButton" action="#{editSectionPage.goTOC}" value="#{msgs.editmodulesections_TOC}" accesskey="#{msgs.toc_access}" title="#{msgs.im_toc_text}" styleClass="BottomImgTOC"/>
					       			<h:commandButton id="editNextButton" actionListener="#{editSectionPage.editNextSectionListener}" rendered="#{editSectionPage.hasNext}" value="#{msgs.editmodulesections_edit_next}" accesskey="#{msgs.next_access}" title="#{msgs.im_next_text}" styleClass="BottomImgNext">
					    					       	
					       			</h:commandButton>
						     	    <h:commandButton id="editNextModButton" actionListener="#{editSectionPage.editNextModuleListener}" rendered="#{!editSectionPage.hasNext && editSectionPage.hasNextModule}" value="#{msgs.editmodulesections_edit_next}" accesskey="#{msgs.next_access}" title="#{msgs.im_next_mod}" styleClass="BottomImgNext">
			          ...
			          <tr>
			          	<td colspan="2" class="maintabledata9" style="padding:4px" >
			          	    <h:outputText id="mod_seq" value="#{editSectionPage.mdBean.cmod.seqNo}. " rendered="#{editSectionPage.autonumber}"/>      
			     			<h:outputText id="text4" value="#{editSectionPage.module.title}" /> &raquo; <h:outputText id="disp_seq" value="#{editSectionPage.sectionDisplaySequence}. " rendered="#{editSectionPage.autonumber}"/> <h:outputText id="text4_1" value="#{editSectionPage.section.title}" />
			          	</td>
			          </tr>	 
	                   <!-- end table header -->
                                   <tr>
									...
									<tr> 
										 <td colspan="2" style="padding:4px">						 									
											...
											<f:subview id="othereditor" rendered="#{editSectionPage.shouldRenderEditor && authorPreferences.shouldRenderFCK}">
												<sakai:inputRichText textareaOnly="false" enableFullPage="true" id="otherMeletecontentEditor" value="#{editSectionPage.contentEditor}"  rows="50" cols="95" width="720" rendered="#{editSectionPage.shouldRenderEditor && authorPreferences.shouldRenderFCK}" collectionBase="#{editSectionPage.FCK_CollId}" resourceId="#{editSectionPage.resourceSectionFile}"/>
											</f:subview>										
              ...
              <tr>
                <td style="padding:3px">
                  <div class="actionBar" align="left">
                    <input type="hidden" id="saveVal" name="saveVal" value="EditSectionForm:submitsave" />
