 ...
 * $Id: list_special_access.jsp 12127 2015-11-25 15:10:28Z mallikamt $  
 ***********************************************************************************
 *
 * Copyright (c) 2010, 2011, 2012, 2015 Etudes, Inc.
 *
 *
...
<h:form id="listspecialaccessform">
   ...
   <h:dataTable id="table" 
                  ...
                  var="saObj"  headerClass="tableheader" rowClasses="row1,row2" columnClasses="ListModCheckClass,ListModCheckClass,ListShortTitleClass,ListDateInputClass,ListDateInputClass,ListDateInputClass,ListDateInputClass" 
...
   <h:column>
     ...
     <h:outputText id="title2" value="#{saObj.userNames}" escape="false"></h:outputText>
       ...
       <h:column>
        ...
        <h:column>
               <f:facet name="header">
             <h:outputText id="t5" value="#{msgs.list_special_access_hideuntilstart}" />
             </f:facet>             
             <h:outputText id="hideuntilstart0" 
                           value="#{msgs.list_special_access_default}"  styleClass="italics"  rendered="#{(saObj.overrideHideUntilStart == false)}">
            </h:outputText>
             <h:outputText id="hideuntilstart1" 
                           value="#{msgs.list_special_access_yes}"  styleClass="italics"  rendered="#{((saObj.hideUntilStart == true)&&(saObj.overrideHideUntilStart == true))}">
            </h:outputText>
                  <h:outputText id="hideuntilstart2" 
                           value="#{msgs.list_special_access_no}"  styleClass="italics"  rendered="#{((saObj.hideUntilStart == false)&&(saObj.overrideHideUntilStart == true))}">
            </h:outputText>
              </h:column>            
