	<!--
 ***********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/webapp/melete/edit_sec_resourcePropertiesPanel.jsp $
 * $Id: edit_sec_resourcePropertiesPanel.jsp 10565 2015-04-22 21:11:20Z mallikamt $  
 ***********************************************************************************
 *
 * Copyright (c) 2008, 2010, 2014, 2015 Etudes, Inc.
 *
...
function fillTitle()
{
	...
	if (v != undefined && vtitle != undefined && vtitle.value.length == 0) document.getElementById("EditSectionForm:ResourcePropertiesPanel:res_desc").value = v.value;
	   ...
	   <h:panelGrid id="propertiesPanel" columns="1" width="100%" styleClass="maintabledata8">
		<h:column rendered="#{(editSectionPage.shouldRenderUpload || editSectionPage.shouldRenderLink || editSectionPage.shouldRenderLTI)}">
