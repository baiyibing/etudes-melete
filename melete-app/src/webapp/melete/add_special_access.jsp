 ...
 * $Id: add_special_access.jsp 12127 2015-11-25 15:10:28Z mallikamt $  
 ***********************************************************************************
 *
         	...
         	<table class="maintableCollapseWithNoBorder" >
              ...
              <tr>
                ...
                <td>
					  ...
					  <h:inputHidden id="overrideHideUntilStart" value="#{specialAccessPage.specialAccess.overrideHideUntilStart}"/>
              ...
              <tr>
                ...
                <td  class="col2" valign="top">
                 <h:selectBooleanCheckbox id="hideuntilstart" title="hideUntilStart" value="#{specialAccessPage.specialAccess.hideUntilStart}">
		         </h:selectBooleanCheckbox>
		         <h:outputText id="hideUntilStartTxt" value="#{msgs.add_special_access_hideuntilstart}" />
			   </td>
		     </tr>
              <tr>
...
<p ><span class="required">*</span>&nbsp;<h:outputText value="#{msgs.edit_module_required}" /></p>
	...
	<script type="text/javascript">
        if (document.getElementById("AddSpecialAccessForm:accessId").value != "0")
        {
        	...
        	if (document.getElementById("AddSpecialAccessForm:overrideHideUntilStart").value != "true")
        	{	
        		document.getElementById("AddSpecialAccessForm:hideUntilStart").value = document.getElementById("AddSpecialAccessForm:hideUntilStart").value;
        }              
        }              
    </script>    
	</h:form>
