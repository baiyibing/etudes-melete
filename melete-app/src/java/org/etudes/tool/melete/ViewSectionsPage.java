/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/java/org/etudes/tool/melete/ViewSectionsPage.java $
 * $Id: ViewSectionsPage.java 10543 2015-04-22 01:42:36Z mallikamt $
 ***********************************************************************************
 *
...
public class ViewSectionsPage implements Serializable
{
	...
	public String getContent()
	{
		...
		try
		{
			...
			str = str.trim();
			if (Util.FindNestedHTMLTags(str)||Util.FindFilmsOnDemand(str))
			{
