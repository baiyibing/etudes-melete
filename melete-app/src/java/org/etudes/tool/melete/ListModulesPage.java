/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/java/org/etudes/tool/melete/ListModulesPage.java $
 * $Id: ListModulesPage.java 9089 2014-10-27 22:47:48Z rashmim $
 ***********************************************************************************
 *
...
public class ListModulesPage implements Serializable
{
	...
	public void goWhatsNext(ActionEvent evt)
	{
		...
		if (isUserAuthor() || isUserStudent() || isUserObserver())
		{
	...
	/**
	 * Check if the current user has permission as observer.
	 * 
	 * @return true if the current user has permission to perform this action, false if not.
	 */
