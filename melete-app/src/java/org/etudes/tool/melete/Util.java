/*******************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/java/org/etudes/tool/melete/Util.java $
 *
 * **********************************************************************************
 *
 * Copyright (c) 2008, 2011, 2015, 2016 Etudes, Inc.
 *
...
public class Util
{
	...
	/**
	 * Returns true if string contains films on demand references
	 * @param str String to check
	 * @return true if string contains films on demand, false if not
	 */
	public static boolean FindFilmsOnDemand(String str)
	{
		if (str == null) return false;
		if (str.contains("https://secure.films.com")||str.contains("https://fod.infobase.com")) return true;
		return false;
	}
