/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-app/src/java/org/etudes/tool/melete/ViewModulesPage.java $
 * $Id: ViewModulesPage.java 10493 2015-04-17 19:50:54Z mallikamt $
 ***********************************************************************************
 *
...
public class ViewModulesPage implements Serializable
{
	...
	public void editModule(ActionEvent evt)
	{
		...
		String courseId = mPage.getCurrentSiteId();
		String userId = mPage.getCurrentUser().getId();
		mPage.setNavigateView(true);
		
		ModuleDateBean mdbean = (ModuleDateBean) getModuleService().getModuleDateBean(userId, courseId, selModId);
