 ...
 * $Id: SpecialAccessPage.java 12127 2015-11-25 15:10:28Z mallikamt $
 ***********************************************************************************
					...
					if (sa != null) 
 {
	...
	public SpecialAccessObjService getSpecialAccess()
	{
		...
		if (specialAccess == null)
		{
			...
			specialAccess.setHideUntilStart(getModule().getModuleshdate().getHideUntilStart());
			specialAccess.setOverrideStart(false);
			specialAccess.setOverrideEnd(false);
			specialAccess.setOverrideAllowUntil(false);
			specialAccess.setOverrideHideUntilStart(false);
		}
