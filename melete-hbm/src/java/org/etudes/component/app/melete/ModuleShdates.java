/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-hbm/src/java/org/etudes/component/app/melete/ModuleShdates.java $
 * $Id: ModuleShdates.java 12509 2016-01-11 17:32:04Z mallikamt $
 ***********************************************************************************
 *
...
public class ModuleShdates implements Serializable, ModuleShdatesService
{
	...
	private Boolean hideUntilStart;
	...
	/** Custom constructor */
	public ModuleShdates(Date startDate, Date endDate, Date allowUntilDate, Boolean addtoSchedule, Boolean hideUntilStart)
	{
		this.startDate = startDate;
		this.endDate = endDate;
	...
	/** full constructor */
	public ModuleShdates(Date startDate, Date endDate, Date allowUntilDate, int version, Boolean addtoSchedule, Boolean hideUntilStart, String startEventId, String endEventId,
	...
	public ModuleShdates(ModuleShdates oldModuleShdates)
	{
		...
		this.addtoSchedule = oldModuleShdates.getAddtoSchedule();
		this.hideUntilStart = oldModuleShdates.getHideUntilStart();
		this.module = null;
	}
	 ...
	 * {@inheritDoc}
	 */
	public Boolean getHideUntilStart()
	{
		if (this.hideUntilStart == null) return Boolean.FALSE;
	...
	public boolean isClosedBeforeFlag()
	{
		...
		if (getAllowUntilDate() != null)
		{
			if (getAllowUntilDate().before(currentDate))
			{
				return true;
			}
			else
	 ...
	 * {@inheritDoc}
	 */
	public boolean isHiddenTillStart()
	{
		Date currentDate = new java.util.Date();
		if ((getHideUntilStart()) && (getStartDate() != null) && (getStartDate().after(currentDate)))
		{
			return true;
		}
		return false;
