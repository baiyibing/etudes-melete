/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-hbm/src/java/org/etudes/component/app/melete/ViewModBean.java $
 * $Id: ViewModBean.java 12509 2016-01-11 17:32:04Z mallikamt $  
 ***********************************************************************************
 *
 * Copyright (c) 2009, 2010, 2011, 2014, 2016 Etudes, Inc.
 *
...
public class ViewModBean implements Serializable, ViewModBeanService
{
	...
	protected boolean hideUntilStart;
	...
	public boolean isClosedBeforeFlag()
	{
		if (visibleFlag == false && blockedBy == null)
		{
			...
			{
				if (getAllowUntilDate().before(currentDate)) return true;
				else return false;
			}
			else
			{
	...
	public boolean isHiddenTillStart()
	{
		...
		{
			Date currentDate = new java.util.Date();
			if ((isHideUntilStart()) && (getStartDate() != null) && (getStartDate().after(currentDate)))
			{
				return true;
			}
		}
