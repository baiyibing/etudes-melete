...
public interface SpecialAccessObjService
{
	...
	/**
	 * @return overrideHideUntilStart
	 */
	public abstract boolean isOverrideHideUntilStart();
	 ...
	 *        overrideHideUntilStart to set
	 */
	public abstract void setOverrideHideUntilStart(boolean overrideHideUntilStart);
