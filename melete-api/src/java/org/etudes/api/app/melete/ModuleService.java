/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-api/src/java/org/etudes/api/app/melete/ModuleService.java $
 * $Id: ModuleService.java 12127 2015-11-25 15:10:28Z mallikamt $
 ***********************************************************************************
 *
...
public interface ModuleService
{
	...
	/**
	 * Check if user has observer access.
	 * 
	 * @param user_id
	 *        The user Id
	 * @param course_id
	...
	/**
	 * Get next sequence number of module that is not deleted or archived. Returns -1 for students. Does not skip invalid modules.
	 * 
	 * @param userId
	 *        User id
	 * @param courseId
	...
	/**
	 * Get previous sequence number of module that is not archived or deleted. Returns -1 for students. Does not skip invalid modules.
	 * 
	 * @param userId
	 *        User id
	 * @param courseId
	...
	/**
	 * Get list of modules with view status set from CourseMap. This method also returns hidden modules.
	 * 
	 * @param userId
	 *        User id
	 * @param courseId
	 ...
	 */
	public List<ViewModBeanService> getCMViewModules(String userId, String courseId, boolean filtered);
	 ...
	 */
	public String isSectionModuleOpen(Date startDate, Date endDate, Date allowUntilDate, Boolean hideUntilStart);
