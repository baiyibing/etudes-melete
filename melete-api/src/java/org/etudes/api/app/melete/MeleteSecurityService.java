/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-api/src/java/org/etudes/api/app/melete/MeleteSecurityService.java $
 * $Id: MeleteSecurityService.java 9089 2014-10-27 22:47:48Z rashmim $  
 ***********************************************************************************
 *
...
public interface MeleteSecurityService
{
	...
	/** Security function name for site observer. */
	public static final String SECURE_OBSERVER = "site.observer";
	...
	/**
	 * Check if the current user has permission as site observer for a particular site.
	 * 
	 * @param reference
	 *        The Site Id
	 * @return
	 * @throws Exception
	 */
	boolean allowObserver(String reference) throws Exception;
