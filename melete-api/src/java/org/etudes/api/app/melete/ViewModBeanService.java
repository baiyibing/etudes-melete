/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-api/src/java/org/etudes/api/app/melete/ViewModBeanService.java $
 * $Id: ViewModBeanService.java 12127 2015-11-25 15:10:28Z mallikamt $
 ***********************************************************************************
 *
 * Copyright (c) 2009, 2010, 2011, 2014 Etudes, Inc.
 *
...
public interface ViewModBeanService
{
	...
	/**
	 * @return the hide until open value
	 */
	public abstract boolean isHideUntilStart();
	
	/**
	 * @return true if start date is after current date and hide until start is set, false if not
	 */
	 ...
	 *        the hideUntilStart flag
	 */
	public abstract void setHideUntilStart(boolean hideUntilStart);
