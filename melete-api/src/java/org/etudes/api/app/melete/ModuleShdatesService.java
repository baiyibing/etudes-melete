/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-api/src/java/org/etudes/api/app/melete/ModuleShdatesService.java $
 * $Id: ModuleShdatesService.java 12127 2015-11-25 15:10:28Z mallikamt $  
 ***********************************************************************************
 *
...
public interface ModuleShdatesService
{
	...
	/**
	 * @return hide until start boolean flag
	 */
	public abstract Boolean getHideUntilStart();
