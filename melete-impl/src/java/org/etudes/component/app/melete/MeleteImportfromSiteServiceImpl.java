/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-impl/src/java/org/etudes/component/app/melete/MeleteImportfromSiteServiceImpl.java $
 * $Id: MeleteImportfromSiteServiceImpl.java 12127 2015-11-25 15:10:28Z mallikamt $
 ***********************************************************************************
 *
	...
	private void buildModules(String fromContext, String toContext)
	{
		...
		for (ListIterator<?> i = fromModuleList.listIterator(); i.hasNext();)
		{
			...
			ModuleShdates toModshdate = new ModuleShdates(fromShDates.getStartDate(), fromShDates.getEndDate(), fromShDates.getAllowUntilDate(),
					fromShDates.getAddtoSchedule(), fromShDates.getHideUntilStart());
