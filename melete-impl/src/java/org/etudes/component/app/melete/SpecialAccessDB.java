 ...
 * $Id: SpecialAccessDB.java 12127 2015-11-25 15:10:28Z mallikamt $
 ***********************************************************************************
 *
	...
	public void setSpecialAccess(SpecialAccess sa) throws Exception
	{
		...
		try
		{
			...
			else
			{
				...
				find_sa.setHideUntilStart(sa.isHideUntilStart());
				...
				find_sa.setOverrideHideUntilStart(sa.isOverrideHideUntilStart());
