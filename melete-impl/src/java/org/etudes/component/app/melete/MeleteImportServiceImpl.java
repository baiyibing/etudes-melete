/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-impl/src/java/org/etudes/component/app/melete/MeleteImportServiceImpl.java $
 * $Id: MeleteImportServiceImpl.java 11466 2015-08-17 22:21:31Z mallikamt $
 ***********************************************************************************
 *
...
public class MeleteImportServiceImpl extends MeleteImportBaseImpl implements MeleteImportService
{
	...
	protected void processLicenseStr(String otherInfo, MeleteResource meleteResource)
	{
		...
		while (commaPos != -1)
		{
			...
			if ((firstStr == null && secondStr == null)||(firstStr.trim().length()==0 && secondStr.trim().length() == 0)) break;
			if (!(firstStr != null && firstStr.length() > 0 && Character.isDigit(firstStr.charAt(firstStr.length() - 1))) && (secondStr != null && secondStr.length() > 0 && Character.isDigit(secondStr.charAt(0))))
			{
				break;
			}
			else
