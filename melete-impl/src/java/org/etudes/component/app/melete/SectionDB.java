/**********************************************************************************
 *
 * $URL: https://source.etudes.org/svn/apps/melete/trunk/melete-impl/src/java/org/etudes/component/app/melete/SectionDB.java $
 * $Id: SectionDB.java 12676 2016-06-02 04:56:40Z rashmim $
 ***********************************************************************************
 *
...
public class SectionDB implements Serializable
{
	...
	public List getAllMeleteResourcesOfCourse(String courseId)
	{
		...
		{
			Session session = hibernateUtil.currentSession();
			String queryString = "select meleteresource.resourceId from MeleteResource meleteresource where meleteresource.resourceId like '/private/meleteDocs/"
				+ courseId + "%'";
			Query query = session.createQuery(queryString);
			List result_list = query.list();
			return result_list;
